...
<head>
    ...
    <title>503 - Layanan Tidak Tersedia | SIGAP-IO</title>
        ...
        <div class="error-card">
            ...
            <div class="card-body">
                <div class="error-message">
                    <p>Maaf, layanan saat ini sedang tidak tersedia.</p>
                    <p>Tim kami sedang melakukan pemeliharaan atau server sedang mengalami masalah. Silakan coba lagi nanti.</p>
                </div>
