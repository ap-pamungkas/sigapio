<div id="header" class="app-header">
    ...
    <img src="{{ url('public/komando') }}/assets/img/user/user-3.jpg"
    alt="" width="16" class="me-2"> Richard Leong
    </div>
    ...
    <div class="widget-chat-media"><img
    src="{{ url('public/komando') }}/assets/img/user/user-2.jpg" alt="" />
    </div>
    ...
    <div class="widget-chat-item">
    <div class="widget-chat-media"><img
    src="{{ url('public/komando') }}/assets/img/user/user-3.jpg"
    alt="" /></div>
    <div class="widget-chat-content">
    ...
    <div class="widget-chat-item">
    <div class="widget-chat-media"><img
    src="{{ url('public/komando') }}/assets/img/user/user-2.jpg"
    alt="" /></div>
    <div class="widget-chat-content">
    <div class="widget-chat-name">Roberto Lambert</div>
