...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ url('public/admin/dist/css/bootstrap-icons.min.css') }}">
    <link rel="stylesheet" href="{{ url('public/admin/dist/css/bootstrap-icons.css') }}">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      <footer class="app-footer">
        ...
        <strong>
          ...
          <a href="#" class="text-decoration-none">sigapioketapang</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
    ...
    <script src="{{ url('public/admin/dist/js/jquery-3.7.1.js') }}"></script>
