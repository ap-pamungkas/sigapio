        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var LegendControl = L.Control.extend({
                ...
                onAdd: function (map) {
                    ...
                    container.innerHTML = `
                        <div class="legend">
                            <h4 class="text-black">Legenda Heatmap</h4>
                            <div class="legend-section">
                                <h5 class="text-black">Suhu (°C)</h5>
                                <div class="text-black"><span class="color-box" style="background-color: blue;"></span> ≤ 10°C</div>
                                <div class="text-black" ><span class="color-box" style="background-color: lime;"></span> 10°C - 20°C</div>
                                <div class="text-black" ><span class="color-box" style="background-color: orange;"></span> 20°C - 30°C</div>
                                <div class="text-black"><span class="color-box" style="background-color: red;"></span> ≥ 45°C</div>
                            </div>
                            <div class="legend-section">
                                <h5 class="text-black">Kualitas Udara</h5>
                                <div class="text-black"><span class="color-box" style="background-color: green;"></span> ≤ 20 (Baik)</div>
                                <div class="text-black" ><span class="color-box" style="background-color: yellow;"></span> 20 - 40 (Sedang)</div>
                                <div class="text-black"><span class="color-box" style="background-color: orange;"></span> 40 - 60 (Tidak Sehat)</div>
                                <div class="text-black"><span class="color-box" style="background-color: black;"></span> ≥ 90 (Berbahaya)</div>
                            </div>
                        </div>
                    `;
                    L.DomEvent.on(container, 'click', L.DomEvent.stopPropagation);
