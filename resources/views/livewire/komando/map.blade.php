...
<div wire:poll>
    ...
    `;
                        ...
                        // Add marker to map
                        const marker = L.marker(petugasLatLng, {
                                icon: petugasIcon
                            })
                            .addTo(map)
                    ...
                    updateStatusIndicator('updated',
                        `${validatedData.length} petugas aktif - ${new Date().toLocaleTimeString('id-ID')}`);
                } else {
            ...
            setInterval(() => {
                try {
                    if (window.Livewire && window.Livewire.all && window.Livewire.all().length > 0) {
                        ...
                        if (mapComponent && mapComponent.__instance.effects.petugasInsidenData && mapComponent
                            .__instance.effects.lastUpdated) {
